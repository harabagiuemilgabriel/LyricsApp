...
//            UrlEncoder encoder,
//            ISystemClock clock,
//            NorvoDBContext context) :base(options,logger,encoder,clock)
//        {
//            _context = context;
//        }
...
//                return AuthenticateResult.Fail("Fail 1");
...
//                UsersTable user = _context.UsersTables.Where(user => user.Email == emailAddress && user.Password == password).FirstOrDefault();
